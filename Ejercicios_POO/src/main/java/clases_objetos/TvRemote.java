...
public class TvRemote {
    ...
    //constructores
    //El constructor tendrá siempre el mismo nombre que la clase que a va a instancias
...
/*
 ...
 //atributos
  int channel; //en qué canal está
  int volume; //en qué nivel de volumen está
  boolean on; //si la tv está encendida o no
  String color; //color del mando a distancia
